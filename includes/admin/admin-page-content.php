...
function copyShortcode() {
    ...
    const shortcodeElement = document.querySelector('.laspad-shortcode-box code');
    const shortcodeText = shortcodeElement.innerText;
    ...
    try {
        ...
        if (successful) {
            const button = document.querySelector('.laspad-copy-btn');
        ...
        alert('Erreur lors de la copie du shortcode');
    }
